...
for IndexPerson = 1 : ThresholdIndividuals
  ...
  plot3(Locations((IndexPerson-1)*5+1 : ((IndexPerson-1)*5)+ThresholdFaces, 1), Locations((IndexPerson-1)*5+1 : ((IndexPerson-1)*5)+ThresholdFaces, 2), Locations((IndexPerson-1)*5+1 : ((IndexPerson-1)*5)+ThresholdFaces, 3), Aspect(IndexPerson , :));
end,
